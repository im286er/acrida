...
import net.gility.acrida.content.BarCode;
import net.gility.acrida.content.ResultBean;
import net.gility.acrida.content.SingInResult;
 ...
 * thread. It draws a viewfinder to util the user place the barcode correctly,
...
//		.putExtras(bundle));
        ...
        OSChinaApi.scanQrCodeLogin(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                ...
                if (result != null && result.getResult() != null
                        && result.getResult().OK()) {
                    ApplicationLoader.showToast(result.getResult().getErrorMessage());
                    finish();
                } else {
                    handler.sendEmptyMessage(R.id.restart_preview);
                    ApplicationLoader.showToast(result != null
            ...
            public void onFailure(int arg0, Header[] arg1, byte[] arg2,
                ...
                if (arg2 != null) {
                    ...
                    ApplicationLoader.showToast("网页登陆失败");
                }
            }
    ...
    private void handleSignIn(BarCode barCode) {
        if (barCode.isRequireLogin() && !ApplicationLoader.getInstance().isLogin()) {
            showLogin();
            return;
        }
        showWaitDialog("正在签到...");
    ...
    private void showCopyTextOption(final String text) {
        DialogHelp.getConfirmDialog(this, text, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                cbm.setText(text);
                ApplicationLoader.showToast("复制成功");
                finish();
            }
        }, new DialogInterface.OnClickListener() {
            @Override
