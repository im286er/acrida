...
public class DownloadService extends Service {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				if (rate < 100) {
					...
					mNotification = newNotificationForLatesEentInfo(mNotification, mContext, "下载完成",
    ...
    private Notification newNotificationForLatesEentInfo(Notification notification, Context context,
		...
		result.flags = notification.flags;
