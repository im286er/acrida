...
import net.gility.acrida.ui.adapter.SoftwareCatalogListAdapter;
...
import net.gility.acrida.ui.widget.ScrollLayout;
...
public class SoftwareCatalogListFragment extends BaseFragment implements
	...
	private static StateView mEmptyView;
	...
	private void initViews(View view) {
		...
		mEmptyView = (StateView) view.findViewById(R.id.error_layout);
