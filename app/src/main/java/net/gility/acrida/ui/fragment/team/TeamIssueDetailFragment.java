...
import net.gility.acrida.content.team.TeamIssueDetail;
import net.gility.acrida.content.team.TeamRepliesList;
import net.gility.acrida.content.team.TeamReply;
import net.gility.acrida.content.team.TeamReplyBean;
...
public class TeamIssueDetailFragment extends BaseFragment implements
    ...
    private final AsyncHttpResponseHandler mChangeIssueHandler = new AsyncHttpResponseHandler() {
        ...
        public void onFailure(int arg0, Header[] arg1, byte[] arg2,
                              Throwable arg3) {
            // TODO Auto-generated method stub
            ApplicationLoader.showToast("更新失败");
        }
    ...
    private void changeIssueState() {
        if (!mTeamIssue.getAuthority().isUpdateState()) {
            ApplicationLoader.showToast("抱歉，无更改权限");
            return;
        }
                ...
                str.toString(), new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        ...
                        if (reply != null) {
                            ...
                            ApplicationLoader.showToast("评论失败");
                        }
                    }
