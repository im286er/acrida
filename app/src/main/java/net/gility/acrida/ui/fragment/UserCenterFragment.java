...
import net.gility.acrida.content.UserInformation;
...
public class UserCenterFragment extends BaseFragment implements
    ...
    private final AsyncHttpResponseHandler mActiveHandler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
            try {
                ...
                mEmptyView.setStateType(StateView.TYPE_HIDE_LAYOUT);
                if (data.size() == 0 && mState == STATE_REFRESH) {
                    mEmptyView.setStateType(StateView.TYPE_NO_DATA);
        ...
        public void onFailure(int arg0, Header[] arg1, byte[] arg2,
                Throwable arg3) {
            mEmptyView.setStateType(StateView.TYPE_NETWORK_ERROR);
        }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        mUid = ApplicationLoader.getInstance().getLoginUid();
    ...
    public void onClick(View v) {
        ...
        case R.id.tv_private_message:
            if (mHisUid == ApplicationLoader.getInstance().getLoginUid()) {
                ApplicationLoader.showToast("不能给自己发送留言:)");
                return;
            }
    ...
    private void fristSendGetUserInfomation() {
        ...
        mEmptyView.setStateType(StateView.TYPE_NETWORK_LOADING);
    ...
    private void handleUserRelation() {
        if (mUser == null)
            return;
        // 判断登录
        final ApplicationLoader ac = ApplicationLoader.getInstance();
        if (!ac.isLogin()) {
            UIHelper.showLoginActivity(getActivity());
            return;
        }
                ...
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        try {
                            ...
                            ApplicationLoader.showToastShort(result.getErrorMessage());
                        } catch (Exception e) {
                            e.printStackTrace();
                            onFailure(arg0, arg1, arg2, e);
                        }
