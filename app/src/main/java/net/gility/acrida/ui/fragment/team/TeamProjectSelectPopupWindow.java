...
import net.gility.acrida.ui.adapter.team.TeamProjectListAdapter;
...
public class TeamProjectSelectPopupWindow extends PopupWindow implements
    ...
    private StateView mErrorLayout;
    ...
    private void initView(Context context) {
        ...
        mErrorLayout = (StateView) view.findViewById(R.id.error_layout);
