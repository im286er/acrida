...
import net.gility.acrida.ui.adapter.team.TeamDiaryListAdapter;
import net.gility.acrida.content.team.TeamDiary;
import net.gility.acrida.content.team.TeamDiaryList;
...
public class DiaryPageContentView {
    ...
    private final StateView errorLayout;
    ...
    public DiaryPageContentView(Context context, int teamId, int year, int week) {
        ...
        errorLayout = (StateView) rootView.findViewById(R.id.error_layout);
        ...
        OSChinaApi.getDiaryFromWhichWeek(teamId, year, week,
                new AsyncHttpResponseHandler() {
                    ...
                    public void onStart() {
                        ...
                        if (isFirst) {
                            errorLayout
                                    .setStateType(StateView.TYPE_NETWORK_LOADING);
                        }
                    }
                    ...
                    public void onFailure(int arg0, Header[] arg1, byte[] arg2,
                        ...
                        /* 网络异常 */
                        if (errorLayout != null) {
                            errorLayout.setStateType(StateView.TYPE_NETWORK_ERROR);
                                ...
                                cxt.runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (tempData == null
                                            ...
                                            errorLayout
                                                    .setStateType(StateView.TYPE_NO_DATA);
                                            errorLayout
