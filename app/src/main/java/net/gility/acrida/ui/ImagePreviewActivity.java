...
import net.gility.acrida.ui.adapter.RecyclingPagerAdapter;
import net.gility.acrida.model.SimpleBackPage;
import net.gility.acrida.ui.fragment.TweetPubFragment;
import net.gility.acrida.ui.dialog.ImageMenuDialog;
import net.gility.acrida.ui.dialog.ImageMenuDialog.OnMenuClickListener;
import net.gility.acrida.utils.TDevice;
import net.gility.acrida.utils.UIHelper;
import net.gility.acrida.ui.widget.HackyViewPager;
...
public class ImagePreviewActivity extends BaseActivity implements
    ...
    private void copyUrl() {
        ...
        if (mAdapter != null && mAdapter.getCount() > 0) {
            ...
            ApplicationLoader.showToastShort("已复制到剪贴板");
        }
    }
    ...
    private void saveImg() {
        if (mAdapter != null && mAdapter.getCount() > 0) {
            ...
            ApplicationLoader.showToastShort(getString(R.string.tip_save_image_suc,
                    filePath));
        } else {
            ApplicationLoader.showToastShort(R.string.tip_save_image_faile);
        }
    }
            ...
            kjbitmap.displayWithDefWH(vh.image, images[position],
                    ...
                    new BitmapCallBack() {
                        ...
                        public void onFailure(Exception arg0) {
                            ApplicationLoader.showToast(R.string.tip_load_image_faile);
                        }
                    });
