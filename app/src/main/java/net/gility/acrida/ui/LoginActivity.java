...
import net.gility.acrida.content.OpenIdCatalog;
...
public class LoginActivity extends BaseActivity implements IUiListener {
    ...
    private final AsyncHttpResponseHandler mHandler = new AsyncHttpResponseHandler() {
        ...
        public void onFailure(int arg0, Header[] arg1, byte[] arg2,
                              Throwable arg3) {
            ApplicationLoader.showToast("网络出错" + arg0);
        }
    ...
    public void initData() {
        ...
        mEtUserName.setText(ApplicationLoader.getInstance()
                .getProperty("user.account"));
        mEtPassword.setText(CyptoUtils.decode("oschinaApp", ApplicationLoader
    ...
    private void wxLogin() {
        ...
        if (!api.isWXAppInstalled()) {
            ApplicationLoader.showToast("手机中没有安装微信客户端");
            return;
        }
        // 唤起微信登录授权
        ...
        mController.doOauthVerify(this, SHARE_MEDIA.SINA,
                new SocializeListeners.UMAuthListener() {
                    ...
                    public void onError(SocializeException arg0,
                                        SHARE_MEDIA arg1) {
                        ApplicationLoader.showToast("新浪授权失败");
                    }
                            ...
                            mController.getPlatformInfo(LoginActivity.this, SHARE_MEDIA.SINA, new SocializeListeners.UMDataListener() {
                                ...
                                public void onComplete(int i, Map<String, Object> map) {
                                    if (i == 200 && map != null) {
                                        ...
                                        ApplicationLoader.showToast("发生错误：" + i);
                                    }
                                }
                            });
                        } else {
                            ApplicationLoader.showToast("授权失败");
                        }
                    }

                    @Override
                    public void onCancel(SHARE_MEDIA arg0) {
                        ApplicationLoader.showToast("已取消新浪登陆");
                    }
                });
    }
    ...
    private void openIdLogin(final String catalog, final String openIdInfo) {
        ...
        OSChinaApi.open_login(catalog, openIdInfo, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ApplicationLoader.showToast("网络出错" + statusCode);
            }
    ...
    private void handleLoginBean(LoginUserBean loginUserBean) {
        if (loginUserBean.getResult().OK()) {
            ...
            if (cookies != null) {
                ...
                ApplicationLoader.getInstance().setProperty(AppConfig.CONF_COOKIE,
                        tmpcookies);
                ApiHttpClient.setCookie(ApiHttpClient.getCookie(ApplicationLoader
                        .getInstance()));
            ...
            ApplicationLoader.getInstance().saveUserInfo(loginUserBean.getUser());
            hideWaitDialog();
            handleLoginSuccess();

        } else {
            ApplicationLoader.getInstance().cleanLoginInfo();
            ApplicationLoader.showToast(loginUserBean.getResult().getErrorMessage());
        }
    }
}
