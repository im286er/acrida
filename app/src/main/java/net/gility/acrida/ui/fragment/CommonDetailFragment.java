...
import net.gility.acrida.content.Report;
...
import net.gility.acrida.ui.dialog.ReportDialog;
import net.gility.acrida.ui.dialog.ShareDialog;
import net.gility.acrida.ui.widget.StateView;
import net.gility.acrida.utils.DialogHelp;
import net.gility.acrida.utils.FontSizeUtils;
...
public abstract class CommonDetailFragment<T extends Serializable> extends BaseFragment implements OnSendClickListener {
    ...
    public void initView(View view) {
        mStateView = (StateView) view.findViewById(R.id.error_layout);
    ...
    protected AsyncHttpResponseHandler mDetailHeandler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
            try {
                ...
                if (detail != null) {
                    mStateView.setStateType(StateView.TYPE_HIDE_LAYOUT);
        ...
        public void onStart() {
            super.onStart();
            mStateView.setStateType(StateView.TYPE_NETWORK_LOADING);
        }
    ...
    protected void executeOnLoadDataError() {
        mStateView.setStateType(StateView.TYPE_NETWORK_ERROR);
        mStateView.setOnLayoutClickListener(new View.OnClickListener() {
    ...
    public void handleFavoriteOrNot() {
        ...
        if (!TDevice.hasInternet()) {
            ApplicationLoader.showToastShort(R.string.tip_no_internet);
            return;
        }
        ...
        AsyncHttpResponseHandler mFavoriteHandler = new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int arg0, Header[] arg1, byte[] arg2,
                                  Throwable arg3) {
                ApplicationLoader.showToastShort(R.string.add_favorite_faile);
            }
    ...
    public void onReportMenuClick() {
        if (mId == 0 || mDetail == null) {
            ApplicationLoader.showToast("正在加载，请稍等...");
        }
        if (!ApplicationLoader.getInstance().isLogin()) {
            UIHelper.showLoginActivity(getActivity());
            return;
        ...
        final TextHttpResponseHandler mReportHandler = new TextHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, Header[] arg1, String arg2) {
                if (TextUtils.isEmpty(arg2)) {
                    ApplicationLoader.showToastShort(R.string.tip_report_success);
                } else {
                    ApplicationLoader.showToastShort(new String(arg2));
                }
            }
            ...
            public void onFailure(int arg0, Header[] arg1, String arg2,
                                  Throwable arg3) {
                ApplicationLoader.showToastShort(R.string.tip_report_faile);
            }
    ...
    public void handleShare() {
        if (mDetail == null || TextUtils.isEmpty(getShareContent())
            ...
            ApplicationLoader.showToast("内容加载失败...");
            return;
        }
    ...
    public void onClickSendButton(Editable str) {
        ...
        OSChinaApi.publicComment(getCommentType(), mId, ApplicationLoader
