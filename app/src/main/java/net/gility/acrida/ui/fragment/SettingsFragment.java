...
public class SettingsFragment extends BaseFragment {
    ...
    public void initView(View view) {
        mTbLoadImg.setOnToggleChanged(new OnToggleChanged() {
            ...
            public void onToggle(boolean on) {
                ApplicationLoader.setLoadImage(on);
            }
        });
        ...
        mTbDoubleClickExit.setOnToggleChanged(new OnToggleChanged() {
            @Override
            public void onToggle(boolean on) {
                ApplicationLoader.set(AppConfig.KEY_DOUBLE_CLICK_EXIT, on);
            }
        });
    ...
    private void caculateCacheSize() {
        ...
        if (ApplicationLoader.isMethodsCompat(android.os.Build.VERSION_CODES.FROYO)) {
