...
import net.gility.acrida.content.FriendsList;
...
import net.gility.acrida.ui.widget.PagerSlidingTabStrip.OnPagerChangeLis;
...
public class NoticeViewPagerFragment extends BaseViewPagerFragment {
    ...
    protected void onSetupTabAdapter(ViewPageFragmentAdapter adapter) {
        ...
        bundle.putInt(FriendsFragment.BUNDLE_KEY_UID, ApplicationLoader.getInstance()
                .getLoginUid());
