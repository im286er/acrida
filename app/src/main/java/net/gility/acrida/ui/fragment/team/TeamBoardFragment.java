...
import net.gility.acrida.content.team.MyIssueState;
...
public class TeamBoardFragment extends BaseFragment {
    ...
    public void initView(View view) {
        ...
        mTvName.setText(ApplicationLoader.getInstance().getLoginUser().getName() + "，"
                + getGreetings());
        mIvAvatarView.setAvatarUrl(ApplicationLoader.getInstance().getLoginUser()
                .getPortrait());
    ...
    private void requestData() {
        OSChinaApi.getMyIssueState(team.getId() + "", ApplicationLoader.getInstance()
