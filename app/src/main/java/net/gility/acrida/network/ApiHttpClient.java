...
//     private static String API_URL = "http://192.168.1.107/%s";
    ...
    public static void setHttpClient(AsyncHttpClient c) {
        ...
        setUserAgent(ApiClientHelper.getUserAgent(ApplicationLoader.getInstance()));
    }
    ...
    public static String getCookie(ApplicationLoader applicationLoader) {
        if (appCookie == null || appCookie == "") {
            appCookie = applicationLoader.getProperty("cookie");
        }
        return appCookie;
    }
}
