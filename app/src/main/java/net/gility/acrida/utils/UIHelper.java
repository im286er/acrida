...
import net.gility.acrida.ui.fragment.FriendsFragment;
...
import net.gility.acrida.ui.help.ICallbackResult;
import net.gility.acrida.ui.help.OnWebViewImageListener;
import net.gility.acrida.android.DownloadService;
import net.gility.acrida.android.DownloadService.DownloadBinder;
import net.gility.acrida.android.NoticeService;
...
import net.gility.acrida.ui.TeamNewIssueActivity;
import net.gility.acrida.ui.DetailActivity;
import net.gility.acrida.ui.EventLocationActivity;
import net.gility.acrida.ui.ImagePreviewActivity;
import net.gility.acrida.ui.LoginActivity;
import net.gility.acrida.ui.SimpleBackActivity;
import net.gility.acrida.ui.TweetActivity;
...
public class UIHelper {
    ...
    public static String setHtmlCotentSupportImagePreview(String body) {
        ...
        if (ApplicationLoader.get(AppConfig.KEY_LOAD_IMAGE, true)
                || TDevice.isWifiOpen()) {
    ...
    public static void openBrowser(Context context, String url) {
        ...
        try {
            ...
            e.printStackTrace();
            ApplicationLoader.showToastShort("无法浏览此网页");
        }
    }
    ...
    public static void sendBroadCast(Context context, Notice notice) {
        if (!((ApplicationLoader) context.getApplicationContext()).isLogin()
                || notice == null)
            return;
    ...
    public static void showUserCenter(Context context, int hisuid,
        ...
        if (hisuid == 0 && hisname.equalsIgnoreCase("匿名")) {
            ApplicationLoader.showToast("提醒你，该用户为非会员");
            return;
        }
        Bundle args = new Bundle();
    ...
    public static void clearAppCache(Activity activity) {
        final Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 1) {
                    ApplicationLoader.showToastShort("缓存清除成功");
                } else {
                    ApplicationLoader.showToastShort("缓存清除失败");
                }
            }
        };
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ApplicationLoader.getInstance().clearAppCache();
                    msg.what = 1;
                } catch (Exception e) {
                    e.printStackTrace();
                    msg.what = -1;
